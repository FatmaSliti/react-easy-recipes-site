        ...
        <div className={styles['about-container']}>
            ...
            <div className={styles['about-text']}>
                ...
                <div className={styles.innertext}>
                    <p>Welcome to <span>Easy Recipes</span>, your go-to source for delicious and easy-to-follow recipes. Our mission is to help home cooks of all skill levels explore the joy of cooking and create mouthwatering dishes in their own kitchens.</p>
                    ...
                    <p>At <span>Easy Recipes</span>, we offer a diverse collection of recipes, cooking tips, and culinary insights. We believe that cooking should be a fun and rewarding experience, and our goal is to make it accessible to everyone.</p>
